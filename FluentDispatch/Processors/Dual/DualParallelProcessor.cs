...
namespace FluentDispatch.Processors.Dual
{
    ...
    internal abstract class DualParallelProcessor<TInput1, TInput2> : DualAbstractProcessor<TInput1, TInput2>
    {
        /// <summary>
        /// <see cref="DualParallelProcessor{TInput1,TInput2}"/>
        /// </summary>
        ...
        protected DualParallelProcessor(AsyncCircuitBreakerPolicy circuitBreakerPolicy,
