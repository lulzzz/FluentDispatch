...
namespace GrandCentralDispatch.Nodes.Remote.Dual
{
    ...
    internal sealed class DualSequentialDispatcherRemoteNode<TInput1, TInput2, TOutput1, TOutput2> :
        ...
        IDualDispatcherRemoteNode<TInput1, TInput2>
    {
        ...
        /// <summary>
        /// <see cref="DualSequentialDispatcherRemoteNode{TInput1,TInput2,TOutput1,TOutput2}"/>
        /// </summary>
        ...
        public DualSequentialDispatcherRemoteNode(
