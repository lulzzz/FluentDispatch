...
namespace GrandCentralDispatch.Nodes.Remote.Async
{
    ...
    internal sealed class AsyncSequentialDispatcherRemoteNode<TInput, TOutput> : AsyncSequentialProcessor<TInput, TOutput, AsyncItem<TInput, TOutput>>,
        IAsyncDispatcherQueueRemoteNode<TInput, TOutput>
    {
        ...
        /// <summary>
        /// <see cref="AsyncSequentialDispatcherRemoteNode{TInput,TOutput}"/>
        /// </summary>
        ...
        public AsyncSequentialDispatcherRemoteNode(
            Host host,
