...
namespace GrandCentralDispatch.Nodes.Local.Unary
{
    ...
    internal sealed class UnaryParallelDispatcherLocalNode<TInput> : UnaryParallelProcessor<TInput>,
        IUnaryDispatcherLocalNode<TInput>
    {
        ...
        /// <summary>
        /// <see cref="UnaryParallelDispatcherLocalNode{TInput}"/>
        /// </summary>
        ...
        public UnaryParallelDispatcherLocalNode(
