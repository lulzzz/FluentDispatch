        ...
        private static readonly Lazy<Task<SqliteConnection>> LazyConnection = new Lazy<Task<SqliteConnection>>(
            async () =>
            {
                ...
                else if (RuntimeInformation.IsOSPlatform(OSPlatform.OSX))
                {
                    ...
                    if (!anyProvider)
                    {
                        Helper.ExtractResource("GrandCentralDispatch.Sqlite.libe_sqlite3.dylib",
                ...
                else if (RuntimeInformation.IsOSPlatform(OSPlatform.Linux))
                {
                    ...
                    if (!anyProvider)
                    {
                        ...
                        Helper.ExtractResource(
                            x64
                                ? "GrandCentralDispatch.Sqlite.libe_sqlite3_x64.so"
                                : "GrandCentralDispatch.Sqlite.libe_sqlite3_x86.so",
