...
namespace GrandCentralDispatch.Tests.Clusters
{
    public class SequentialClusterFixture : IDisposable
    {
        ...
        public SequentialClusterFixture()
        {
    ...
    public class SequentialClusterTestData : TheoryData<Message[]>
    {
        public SequentialClusterTestData()
        {
    ...
    public class SequentialClusterTest : IClassFixture<SequentialClusterFixture>
    {
        private readonly SequentialClusterFixture _parallelClusterFixture;
        private readonly ITestOutputHelper _testOutputHelper;

        public SequentialClusterTest(SequentialClusterFixture parallelClusterFixture,
        ...
        [Theory]
        [ClassData(typeof(SequentialClusterTestData))]
        public async Task Cluster_Should_Dispatch_Messages_Sequentially(Message[] messages)
        {
            // Act
